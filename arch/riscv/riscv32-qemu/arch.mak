...
CFLAGS = -Wall -march=rv32imazicsr -mabi=ilp32 -O2 -c -mstrict-align -ffreestanding -nostdlib -fomit-frame-pointer $(INC_DIRS) -DF_CPU=${F_CLK} -D USART_BAUD=$(SERIAL_BAUDRATE) -DF_TIMER=${F_TICK} -DLITTLE_ENDIAN $(CFLAGS_STRIP) -DMULTICORE -D_RISCV32_QEMU -DMEASURE_STATIC=1 -DPERFORMANCE_PRINT
ARFLAGS = r
